            ...
            <Container>
                <div className='site-header__wrapper flex items-center justify-between'>
                    ...
                    <aside
                        ...
                        <div className='sidebar__top p-6 border-b border-slate-200 flex items-center justify-between'>
                            ...
                            <button onClick={() => setIsChecked(false)}>
                                <X className='hover:bg-slate-200 active:bg-slate-300 rounded-md w-8 h-8 cursor-pointer' />
                            </button>
                        </div>
                    ...
                    <button
                        ...
                        <Menu className='hover:bg-slate-200 active:bg-slate-300 rounded-xs w-8 h-8 cursor-pointer' />
                    </button>
                </div>
            </Container>
        </header>
